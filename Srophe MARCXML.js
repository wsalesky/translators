{
	...
	"label": "Srophe MARCXML",
	"creator": "Winona Salesky",
	"target": "xml",
	"minVersion": "3.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	"translatorType": 1,
	"lastUpdated": "2020-02-14 16:18:15"
}
...
function doImport() {
	...
	translator.getTranslatorObject(function (marc) {
		...
		for (let rec of records) {
			...
			var oclcValue = ZU.xpathText(rec, "./marc:controlfield[@tag='001']/text()", ns);
			oclc = "OCLC:" + oclcValue + ".";
...
var testCases = [
	...
	},
	{
		...
		"items": [
			{
				"itemType": "book",
				"title": "The aqueducts of Israel",
				"creators": [],
				"date": "2002",
				"ISBN": "1887829466 9781887829465",
				"numPages": "459",
				"place": "Portsmouth, R.I",
				...
				"notes": [
					{
						"note": "Folded, colored map in pocket"
					},
					{
						"note": "OCLC:50148048."
					}
